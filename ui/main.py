...
"}            ")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 2, 1081, 631))
        ...
        self.cbox_company = QtWidgets.QComboBox(self.layoutWidget)
        ...
        self.horizontalLayout_2.addWidget(self.cbox_company)
        ...
        self.le_search_sku = QtWidgets.QLineEdit(self.layoutWidget)
        self.le_search_sku.setObjectName("le_search_sku")
        self.horizontalLayout.addWidget(self.le_search_sku)
        self.btn_test = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(240, 20, 121, 42))
        ...
        self.verticalLayout_3.addWidget(self.lbl_root_color)
        ...
        self.verticalLayout_3.addWidget(self.le_root_color)
        self.layoutWidget_3 = QtWidgets.QWidget(self.tab)
        self.layoutWidget_3.setGeometry(QtCore.QRect(107, 20, 121, 42))
        ...
        self.verticalLayout_4.addWidget(self.lbl_root_sku_name)
        ...
        self.verticalLayout_4.addWidget(self.le_root_sku_name)
        self.layoutWidget_4 = QtWidgets.QWidget(self.tab)
        self.layoutWidget_4.setGeometry(QtCore.QRect(460, 20, 121, 42))
        ...
        self.verticalLayout_5.addWidget(self.lbl_variable_syntax)
        ...
        self.verticalLayout_5.addWidget(self.le_variable_syntax)
        self.layoutWidget_5 = QtWidgets.QWidget(self.tab)
        self.layoutWidget_5.setGeometry(QtCore.QRect(380, 20, 71, 42))
        ...
        self.verticalLayout_6.addWidget(self.lbl_variable_count)
        ...
        self.verticalLayout_6.addWidget(self.sbox_variables)
        self.chk_active = QtWidgets.QCheckBox(self.tab)
        self.chk_active.setGeometry(QtCore.QRect(610, 40, 70, 17))
        self.chk_active.setStyleSheet("font-weight: bold;\n"
"font-size: 12px;\n"
"")
        self.chk_active.setObjectName("chk_active")
        self.widget = QtWidgets.QWidget(self.tab)
        self.widget.setGeometry(QtCore.QRect(20, 20, 71, 42))
        self.widget.setObjectName("widget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.lbl_root_sku = QtWidgets.QLabel(self.widget)
        self.lbl_root_sku.setObjectName("lbl_root_sku")
        self.verticalLayout_2.addWidget(self.lbl_root_sku)
        self.le_root_sku = QtWidgets.QLineEdit(self.widget)
        self.le_root_sku.setAlignment(QtCore.Qt.AlignCenter)
        self.le_root_sku.setObjectName("le_root_sku")
        self.verticalLayout_2.addWidget(self.le_root_sku)
        self.le_root_sku.raise_()
        self.lbl_root_sku.raise_()
        self.layoutWidget_2.raise_()
        self.layoutWidget_3.raise_()
        self.cbox_company.raise_()

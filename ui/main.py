...
"}            ")
        ...
        self.btn_test.setGeometry(QtCore.QRect(200, 190, 75, 23))
        self.btn_test.setObjectName("btn_test")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(30, 30, 221, 44))
        self.widget.setObjectName("widget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.lbl_company = QtWidgets.QLabel(self.widget)
        self.lbl_company.setObjectName("lbl_company")
        self.verticalLayout.addWidget(self.lbl_company)
        self.cbox_company = QtWidgets.QComboBox(self.widget)
